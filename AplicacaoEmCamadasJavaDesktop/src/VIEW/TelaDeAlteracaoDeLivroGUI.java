 ...
 * @author Kauê
 */
public class TelaDeAlteracaoDeLivroGUI extends javax.swing.JFrame {

    /**
     * Creates new form TelaDeAlteracaoDeLivro
     */
    public TelaDeAlteracaoDeLivroGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTituloDeAlterar.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaDeAlteracaoDeLivroGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaDeAlteracaoDeLivroGUI().setVisible(true);
            }
        });
    }
